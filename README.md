...
All SRPMs from EL9 were not rebuilt, no new RPMS for this will be built unless 
...
*  Logs from the last test build(armv6) using mock is in : mockresults  
...
---
---
Below has some helpful info imported from RSEL, some bits may nor may not be needed for native building. Some of the instructions
...
is a hobbiest project and not commerical**
